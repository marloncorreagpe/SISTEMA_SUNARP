...
DECLARE @lote_demo INT = (SELECT id FROM lotes_seguimiento WHERE nombre_lote = 'DEMO_2026_01');
...
SELECT COUNT(*) AS total_titulos FROM titulos_registrales;
SELECT * FROM vw_resumen_estado ORDER BY cantidad DESC;
